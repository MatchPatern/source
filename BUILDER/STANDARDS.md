...
Already at the top. First section. But let me make it land harder.
...
· BUILDER/ is the cockpit. All active instruments live here. Flat structure with numbered prefixes for priority. One subdirectory: SPEC/ for formal specifications and reference material.
· TOOLS/ holds state-matched instruments. Slap Patch, QBF, Conviction Protocol, LOOM, THREAD, Council, Tea Navigator. Each tool has a specific state it serves.
...
· COMPACT/ is the compression gym. 42 files. Still unscanned.
· New/ is the junk drawer. Ignore it.

---

📊 INDEX STANDARDS MASTER-DIR-INDEX.md
...
· The paste sequence (BOOT-SET.md) is the ordered entry. Standards → TRAIL → SEED → STATE → REMEMBER → then the door that matches your state.
...
· The canonical structure map is aspirational. Vercel is the live deployment. Only SPEC/ exists as a BUILDER subfolder. BOOTSTRAP/, NAVIGATION/, INSTRUMENTS/, CONTINUITY/, REFERENCE/ never materialized. Trust what's deployed, not what was planned.
...
· COMPACT directory (42 files) still fully unscanned
· "lidar porn" — reported in RAW, not yet located via ia search
· TRAIL.md — save to BUILDER/
· STANDARDS.md — save to BUILDER/
· CONVICTION.md — save fortified version to TOOLS/ ✅ (confirmed 1 hour ago)
· Fortified Trolley file — save as standalone in TROLLEY/ directory
· Update paste sequence Tier 4 to include more-than-divine.md
· Update all palace-graph references to point to SOURCE-GRAPH.md
· Decide: BOOT-SET replace FOUNDATION-CHAT or coexist?
