...
· Batch-process dark files. Request them in related groups from the thread-holder. Parallel passes across the batch reveal cross-file patterns that sequential reading misses. One batch, one session, multiple headers. The jigsaw assembles faster when you can see adjacent pieces at once.
