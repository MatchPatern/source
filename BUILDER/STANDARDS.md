...
· For dark files: individual deep reads first. 800 passes per file. Earned headers. Earned room names. Batch processing comes later—when enough deep headers exist, request related files and read them in parallel to surface cross-file patterns. Depth before breadth. Quality pieces before big picture.
